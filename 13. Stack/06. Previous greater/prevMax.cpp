/*
    Given an array of distinct integers, find its previous greater array 
    (position-wise max and closest on the left side) of every array elements.
...
// Find positionwise greater element in left O(n)
